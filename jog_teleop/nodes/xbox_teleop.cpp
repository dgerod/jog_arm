...
public:
  xboxToTwist() : spinner_(1)
  {
    ...
    twist_pub_ = n_.advertise<geometry_msgs::TwistStamped>("jog_arm_server/cartesian_cmds", 1);
    joint_delta_pub_ = n_.advertise<jog_msgs::JogJoint>("jog_arm_server/joint_cmds", 1);
